            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Absensi IPS</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ips-10.php" style="text-decoration: none;">
                        ...
                        <!-- Earnings (data guru) -->
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ips-11.php" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ips-12.php" style="text-decoration: none;">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
