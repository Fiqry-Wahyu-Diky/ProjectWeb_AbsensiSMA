            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Absensi IPA</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ipa-10.php" style="text-decoration: none;">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <i class="fas fa-solid fa-vial fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Earnings (data guru) -->
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ipa-11.php" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="data-ipa-12.php" style="text-decoration: none;">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
